...
public class Starbucks_ {
    ...
    public static double frappuccino(Scanner scanner) {
        ...
        if (eleccion >= 1 && eleccion <= 10) {
            ...
            switch (eleccion) {
                case 1:
                    frappuccinototal = 17.50 * cantidad;
                    break;
                case 2:
                    frappuccinototal = 17.50 * cantidad;
                    break;
                case 3:
                    frappuccinototal = 17.00 * cantidad;
                    break;
                case 4:
                    frappuccinototal = 16.00 * cantidad;
                    break;
                case 5:
                    frappuccinototal = 18.00 * cantidad;
                    break;
                case 6:
                    frappuccinototal = 16.00 * cantidad;
                    break;
                case 7:
                    ...
                    break;
                case 8:
                    frappuccinototal = 16.50 * cantidad;
                    break;
                case 9:
                    frappuccinototal = 16.00 * cantidad;
                    break;
    ...
    public static double CafeCaliente(Scanner sc) {
        ...
        if (eleccion >= 1 && eleccion <= 10) {
            ...
            switch (eleccion) {
                case 1:
                    CafeCalientetotal = 15.50 * cantidad;
                    break;
                case 2:
                    CafeCalientetotal = 15.00 * cantidad;
                    break;
                case 3:
                    CafeCalientetotal = 13.00 * cantidad;
                    break;
                case 4:
                    CafeCalientetotal = 15.00 * cantidad;
                    break;
                case 5:
                    ...
                    break;
                case 6:
                    CafeCalientetotal = 14.50 * cantidad;
                    break;
                case 7:
                    CafeCalientetotal = 15.50 * cantidad;
                    break;
                ...
                case 9:
                    ...
                    break;
                case 10:
                    CafeCalientetotal = 16.00 * cantidad;
                    break;
                default:
                    System.out.println("Opción inválida");
            }
